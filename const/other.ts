...
const MAX_LENGTH = 50
const MAX_LENGTH_IDENTITY_DOCUMENT = 15
const MIN_LENGTH_NUMBER = 7
const MAX_LENGTH_ADDRESS = 50
const MAX_LENGTH_NUMBER_PHONE = 13
...
const MAX_LENGTH_NUMBER_PHONE_MESSAGE = 'Máximo 13 caracteres'
const COUNTRY_MESSAGE = 'País no válido'
