      ...
      <div className="px-8 lg:px-28 py-16 text-center space-y-8 lg:space-y-16">
        ...
        <div className="flex flex-col gap-16 lg:flex-row lg:justify-between lg:items-center">
          <div className="flex flex-col gap-2 lg:basis-1/5">
            {cars.map((data) => (
              <button
                ...
                } text-left p-4 text-xl font-semibold hover:bg-custom-purple hover:text-white transition-all duration-300 ease-linear`}
          ...
          <div className="w-fit m-auto space-y-4 lg:space-y-6 lg:basis-1/5">
            <div>
              <h1 className="bg-custom-purple p-2 text-white flex items-center gap-2 justify-center">
            ...
            <div>
              <a
                href="#booking"
                className="text-xl block w-full font-bold bg-custom-purple p-2 text-white shadow-purple-bottom hover:shadow-purple-bottom-hov transition-all duration-300 ease-linear rounded"
              >
                Reserve Now
              </a>
            </div>
