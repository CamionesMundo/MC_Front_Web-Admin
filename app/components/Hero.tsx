        ...
        <div className="space-y-8 text-center lg:text-left lg:max-w-lg">
          <div className="font-bold space-y-2">
            ...
            <h1 className="text-[3.2rem] leading-tight">
              Save <span className="text-custom-purple">big</span> with our car
              rental
            </h1>
          </div>
          <div>
          ...
          <div className="flex flex-col lg:flex-row text-white font-bold gap-6">
            <a
              href="#booking"
              className="bg-custom-purple flex items-center gap-2 justify-center py-4 px-4 lg:px-8 shadow-purple-bottom hover:shadow-purple-bottom-hov transition-all duration-300 ease-linear rounded border-2 border-custom-purple"
            >
              <span>Book Ride</span>
